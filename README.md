...
- Individual experiments are implementated in [`RAM_centered.py`](RAM_ASD_TD_cat_train_test.py),[`RAM_translated.py`](RAM_translated.py) and [`RAM_cluttered.py`](RAM_cluttered.py)
